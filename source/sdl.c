...
void loadTextures()
{
    ...
    imageLoad(&re_icon,        "romfs:/re_icon.png");
...
void sdlInit()
{
    ...
    main_window = SDL_CreateWindow("splatgian", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_W, SCREEN_H, SDL_WINDOW_SHOWN);
